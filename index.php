...
<div class=\"body_padded\">
	<h1>Welcome to Darn Vulnerable Web Application!</h1>
	<p>Darn Vulnerable Web Application (DVWA) is a PHP/MySQL web application that is darn vulnerable. Its main goal is to be an aid for security professionals to test their skills and tools in a legal environment, help web developers better understand the processes of securing web applications and to aid both students & teachers to learn about web application security in a controlled class room environment.</p>
